...
public static Iterator<String> flatten(Iterator<Iterator<String>> iters) {
		return new Iterator<String>() { 
            final Iterator<Iterator<String>> iter  = new Iterator<Iterator<String>>(iters);
            private Iterator<String> curIter=null;
            private String nextItem=advanceItem();
            private String advanceItem(){
                if(iter==null&&curIter==null) throw new NullPointerException();
                while((iter!=null&&iter.hasNext())||(curIter!=null&&curIter.hasNext())){
